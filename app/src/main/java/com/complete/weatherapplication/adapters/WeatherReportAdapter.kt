...
class WeatherReportAdapter(var list:ArrayList<Daily>, private val ctx:Context): RecyclerView.Adapter<WeatherReportAdapter.AdapterViewHolder>() {
    ...
    override fun onBindViewHolder(holder: AdapterViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            pressure.text = "Preasure - ${daily.pressure}hPa"
